...
class DataTransformation:
    ...
    def get_data_transformer_object(cls)->Pipeline:
        '''
        Initialize the KNNImputer object with the parameters specified in the training_pipeline.py file
        ...
        try:
            ...
            # ** will unwrap the dictionary object
            logging.info(f"Initialized with {DATA_TRANSFORMATION_IMPUTER_PARAMS}")
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact:
        ...
        try:
            ...
            # c_ : used to combine 1D arrays into a 2D matrix.

            # Save numpy array data
            save_numpy_array_data(self.data_transformation_config.transform_train_file_path,data_array=train_arr,)
            save_numpy_array_data(self.data_transformation_config.transformed_test_file_path,data_array=test_arr,)
