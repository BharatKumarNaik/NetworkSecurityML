...
class ModelTrainer:
    ...
    def train_model(self,X_train,y_train,X_test,y_test):
        ...
        logging.info(f"Models used are {list(models.keys())}")
        ...
        logging.info("Evaluating Models with hyper-parameters")
        ...
        # We use it to log in the ML flow
        ...
        # Here instead of loading it locally we load it in the cloud.
