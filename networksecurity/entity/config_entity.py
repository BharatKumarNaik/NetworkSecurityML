...
class DataIngestionConfig:
    def __init__(self,training_pipeline_config: TrainingPipelineConfig):
        try:
            ...
            self.feature_store_path = os.path.join(self.feature_store_dir,training_pipeline.DATA_INGESTION_FEATURE_STORE_FILENAME)
...
class DataValidationConfig:
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.drift_report_file_path:str = os.path.join(
            ...
            training_pipeline.DATA_VALLIDATION_DRIFT_REPORT_DIR,
...
class DataTransformationConfig:
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.transform_train_file_path:str = os.path.join(self.data_transformation_dir,training_pipeline.DATA_TRANSFORMATION_TRANSFORMED_DATA_DIR
